...
from Events.Consumers.negociacao_consumer import iniciar_consumidor_negociacao
...
async def lifespan(app: FastAPI):
    ...
    thread_kafka_negociacao = Thread(
        target=iniciar_consumidor_negociacao,
        name="kafka-negociacao-consumer",
        daemon=True,
    )
    thread_kafka_negociacao.start()
    print("[INFO] Consumidor Kafka de Negociacao iniciado em background.")
